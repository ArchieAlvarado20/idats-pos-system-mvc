              ...
              <form action="" method="post">
                    <?php date_default_timezone_set("Asia/Manila"); ?>
                            <div class="row d-flex mb-3">
                              <div class="col-sm-5">
                              <h3 class="text-secondary "><strong><i class="fa fa-hamburger"></i>Cancelled Items</strong> </h3>
                              </div>
                                  <div class="col-sm-2">
                ...
                <?php foreach ($sales as $sale):?>
                            <tr>
                              ...
                              <td>
                              <a type="button" class="btn btn-sm btn-danger" href="index.php?pg=cancelled-items-details&id=<?=$sale['id'] ?>"><i class="fa fa-eye"></i></a>
                            </td>
