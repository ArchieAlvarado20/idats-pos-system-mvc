              ...
              <div class="card-body ">
                    ...
                    <?php date_default_timezone_set("Asia/Manila"); ?>
                            <div class="row d-flex mb-3">
                              <div class="col-sm-5">
                              <h3 class="text-secondary "><strong><i class="fa fa-hamburger"></i>Sold Items</strong> </h3>
                              </div>
                                  <div class="col-sm-2">
                                    
                                        <label for="">Cashier</label>
                                        <select class="form-control" id="cashier" name="cashier" required oninvalid="this.setCustomValidity('Please select cashier')">
                ...
                <?php foreach ($sales as $sale):?>
                            <tr>
                              ...
                              <?= $sale['status'] == 'Sold' ? "<span class='badge badge-success text-sm'>Sold</span>" : "<span class='badge badge-success text-sm'>Sold</span>" ?></td>
                              <td>
                                <a class="btn btn-sm btn-danger m-0" href="index.php?pg=cancel-sold-items&id=<?=$sale['id'] ?>" ><i class="fa fa-trash"></i> </a>
